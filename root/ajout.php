...
if (isset($_POST["submit"])) {
    if (isset($_POST['nom'])&&isset($_POST['prenom'])&&isset($_POST['mail'])) {
        ...
        $retour=$conn->query("SELECT mail from user where mail = '".$_POST['mail']."'");
        if ($retour) {
            echo"Adresse Mail exist";
        } else {
            $sql="INSERT INTO `user` (`nom`, `prenom`,`mail`, `role`) VALUES ( :nom, :prenom, :mail, 'admin')";
